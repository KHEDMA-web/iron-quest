...
// 5 recettes de shake distinctes (630 kcal / 30 g P chacune) réparties sur la semaine : le bouton
// 🎲 Régénérer d'un repas ne peut piocher que parmi des recettes au texte différent du jour
// courant (voir regenerateMeal dans DayTab.tsx) — les garder toutes visuellement différentes.
const SHAKE_ITEMS_CLASSIQUE = ['300 ml lait de soja', '1 banane', '60 g avoine', '25 g beurre de cacahuète']
const SHAKE_STEPS_CLASSIQUE_POST = ['Blender le lait de soja, la banane, l’avoine et le beurre de cacahuète 30-45 s.', 'À boire dans l’heure qui suit la séance, idéalement.']

const SHAKE_ITEMS_CACAO = ['300 ml lait de soja', '1 banane', '30 g cacao en poudre non sucré', '50 g avoine', '15 g beurre de cacahuète']
const SHAKE_STEPS_CACAO = ['Mets le lait de soja, la banane, le cacao, l’avoine et le beurre de cacahuète dans un blender.', 'Mixe 30-45 s jusqu’à texture lisse et chocolatée. Ajoute un glaçon si tu le veux bien frais.']

const SHAKE_ITEMS_FRUITS_ROUGES = ['300 ml lait de soja', '100 g fruits rouges surgelés', '50 g avoine', '25 g beurre de cacahuète']
const SHAKE_STEPS_FRUITS_ROUGES = ['Mets le lait de soja, les fruits rouges, l’avoine et le beurre de cacahuète dans un blender.', 'Mixe 30-45 s : les fruits surgelés donnent une texture bien fraîche, façon milkshake.']

const SHAKE_ITEMS_MANGUE = ['300 ml lait de soja', '100 g mangue surgelée', '1 fruit de la passion', '40 g avoine', '15 g beurre de cacahuète']
const SHAKE_STEPS_MANGUE = ['Mets le lait de soja, la mangue, le fruit de la passion, l’avoine et le beurre de cacahuète dans un blender.', 'Mixe 30-45 s jusqu’à texture lisse et onctueuse, façon shake exotique.']

const SHAKE_ITEMS_CAFE = ['300 ml lait de soja', '1 banane', '40 g avoine', '1 c. à c. café soluble', '20 g beurre de cacahuète']
const SHAKE_STEPS_CAFE = ['Mets le lait de soja, la banane, l’avoine, le café soluble et le beurre de cacahuète dans un blender.', 'Mixe 30-45 s jusqu’à texture lisse. Un coup de fouet avant la séance ou pour tenir l’aprèm.']
...
export const MENUS: DayMenu[] = [
  {
    name: 'Dimanche', meals: [
      ...
      { id: 's', title: 'Shake bâtisseur', kcal: 630, p: 30, shake: true, items: SHAKE_ITEMS_CACAO, steps: SHAKE_STEPS_CACAO },
      {
  ...
  },
  {
    name: 'Lundi', meals: [
      ...
      { id: 's', title: 'Shake post-séance', kcal: 630, p: 30, shake: true, items: SHAKE_ITEMS_CLASSIQUE, steps: SHAKE_STEPS_CLASSIQUE_POST },
      {
  ...
  },
  {
    name: 'Mardi', meals: [
      ...
      { id: 's', title: 'Shake post-séance', kcal: 630, p: 30, shake: true, items: SHAKE_ITEMS_FRUITS_ROUGES, steps: SHAKE_STEPS_FRUITS_ROUGES },
      {
  ...
  },
  {
    name: 'Mercredi', meals: [
      ...
      { id: 's', title: 'Shake bâtisseur', kcal: 630, p: 30, shake: true, items: SHAKE_ITEMS_MANGUE, steps: SHAKE_STEPS_MANGUE },
      {
  ...
  },
  {
    name: 'Jeudi', meals: [
      ...
      { id: 's', title: 'Shake post-séance', kcal: 630, p: 30, shake: true, items: SHAKE_ITEMS_CAFE, steps: SHAKE_STEPS_CAFE },
      {
